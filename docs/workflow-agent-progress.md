...
- Final repository gates passed with 894 tests (`59` shared, `11` Agent, `598` API, `219` Web, `7` Desktop), the root production build, and 9 real-browser tests. The root test command now includes the Desktop workspace. The current unsigned NSIS installer is 331,302,607 bytes with SHA-256 `0EC59A36B8B58884328EF046306D91592EBBC16F2B005D85CDB96D5EA231A054`.
