...
- Final repository gates passed with 893 tests (`59` shared, `11` Agent, `597` API, `219` Web, `7` Desktop), the root production build, and 9 real-browser tests. The root test command now includes the Desktop workspace. The current unsigned NSIS installer is 331,303,161 bytes with SHA-256 `A552464A95E4ABBFB460EED30E1DB33209B02B6572765C7C4F04A3A6157A0B2D`.
