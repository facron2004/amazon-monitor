...
CREATE INDEX IF NOT EXISTS idx_asin_watch_states_level ON asin_watch_states(watch_level);
CREATE INDEX IF NOT EXISTS idx_asin_watch_states_last_event ON asin_watch_states(last_event_date);
